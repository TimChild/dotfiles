...
def convert_images_to_webp(directory: str, max_width: int, max_height: int) -> None:
    ...
    for filepath in directory_path.iterdir():
        ...
        try:
            ...
            with Image.open(filepath) as img:
                ...
                img.save(new_filename, "webp", optimize=True, quality=70, method=6)
...
def main(
    ...
    convert_images_to_webp(directory, max_width, max_height)
